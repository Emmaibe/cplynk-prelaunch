        ...
        <div className="fixed w-full z-30 px-2">
            <div className="relative px-3 py-14 max-w-[588px] h-[85vh] flex flex-col items-center bg-secondary rounded-[50px] max-sm:rounded-[30px]">
                ...
                <div className="text-center max-w-[450px] mx-auto shrink-0">
                    <h2 className="font-bold text-[40px] text-primary max-sm:text-[28px]">Join Waitlist</h2>
                    ...
                    >
                        <div className="space-y-7">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative mt-3">
                                                <Input
                                                    ...
                                                    className="h-[50px] rounded-lg bg-white px-5 pr-14 text-[20px] text-[#1B1B1B] max-sm:text-sm"
                                                />
                                                <User
                                                    size={20}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative mt-3">
                                                <div className="absolute left-5 top-1/2 -translate-y-1/2 flex items-center gap-3">
                                                    <div className="h-6 w-6 overflow-hidden rounded-full border border-black/10 max-sm:h-5 max-sm:w-5">
                                                    ...
                                                    <span className="text-[18px] text-black/70 max-sm:text-sm">+234</span>
                                                ...
                                                <Input
                                                    ...
                                                    inputMode="numeric"
                                                    aria-invalid={isInvalid}
                                                    className="h-[50px] rounded-lg bg-white pl-[150px] pr-14 text-[20px] text-[#1B1B1B] max-sm:text-sm max-sm:pl-[105px]"
                                                />
                            ...
                            <motion.button
                                type="submit"
                                whileTap={{ scale: 0.97 }}
                                className="mt-6 w-full cursor-pointer text-text_color px-6 py-3.5 rounded-[14px] bg-primary text-base font-bold max-sm:text-sm"
                            >
                                Join Waitlist
                            </motion.button>
                        </div>
